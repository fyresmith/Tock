...
export function StopPrompt({ onClose }: StopPromptProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-[var(--surface-1)] border border-[var(--border-strong)] rounded-2xl w-full max-w-lg p-6 shadow-2xl animate-slide-up"
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-[var(--surface-2)] border border-[var(--border)] rounded-lg px-3 py-2.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] resize-none focus:border-[var(--brand)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-muted)] transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <TagSelect
              ...
              value={tagId}
              onChange={setTagId}
              className="w-full bg-[var(--surface-2)] border border-[var(--border)] rounded-lg px-3 py-2.5 text-sm text-[var(--text-primary)] focus:border-[var(--brand)] focus:outline-none"
            />
        ...
        <div className="flex gap-2 mt-6">
          <button
            ...
            className="px-4 py-2 rounded-lg text-sm text-[var(--danger)] hover:bg-[var(--surface-2)] transition-colors"
          >
            Discard
          </button>
          ...
          <button
            ...
            className="px-5 py-2 rounded-lg bg-[var(--brand)] hover:bg-[var(--brand-hover)] text-white text-sm font-medium disabled:opacity-50 transition-colors"
          >
